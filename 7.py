...
for test_size in [0.1, 0.3]:
    run_knn_experiment(X_glass, y_glass, dataset_name="Glass", test_size=test_size, distance_metric=euclidean_distance, metric_name="Euclidean")
    run_knn_experiment(X_glass, y_glass, dataset_name="Glass", test_size=test_size, distance_metric=manhattan_distance, metric_name="Manhattan")
...
for test_size in [0.1, 0.3]:
    run_knn_experiment(X_fruit, y_fruit, dataset_name="Fruit", test_size=test_size, distance_metric=euclidean_distance, metric_name="Euclidean")
    run_knn_experiment(X_fruit, y_fruit, dataset_name="Fruit", test_size=test_size, distance_metric=manhattan_distance, metric_name="Manhattan")
